...
<body class=" " style="background-image: url(moon.jpg);    background-repeat:no-repeat;background-size: cover;">
<?php require_once "navbar.php" ?>

<div class="container-fluid row text-center d-flex justify-content-center m-0 p-0 mt-4 " style="height:85vh;">
    <form method="POST" class=" col-10 col-sm-8 col-md-6 col-lg-4 row container d-flex justify-content-center  pb-4 pt-3 " style="background-color: #33d1ccd0;color: var(--green); border-radius: 30px; ">
